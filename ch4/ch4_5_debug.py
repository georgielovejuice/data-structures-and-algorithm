...
class CandyCrush:
    ...
    def debug_mirror(self):
        print("🔍 DEBUG: Mirror collapse")
        queue, result, count = self.collapse_mirror_side(self.mirror_side)
        print(f"Original mirror: {self.mirror_side}")
        print(f"Final mirror: {result}")
        print(f"Explosions: {count}")
        print(f"Queue: {queue}")

    def debug_normal(self):
        print("🔍 DEBUG: Normal collapse using mirror bomb queue")
        mirror_queue, _, _ = self.collapse_mirror_side(self.mirror_side)
        failed, result, count = self.collapse_normal_side(self.normal_side, mirror_queue)
        print(f"Original normal: {self.normal_side}")
        print(f"Final normal: {result}")
        print(f"Explosions: {count}")
        print(f"Failed block attempts: {failed}")
...
def main():
    ...
    # For full simulation output
    candycrush.run()

    # Optional: Debug mode
    candycrush.debug_mirror()
    candycrush.debug_normal()
